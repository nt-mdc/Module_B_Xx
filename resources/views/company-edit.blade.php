                ...
                <form method="POST" action="{{ route('company.edit', ['id' => $company['id']]) }}"
                    ...
                    <div>
                        ...
                        <x-text-input id="company_name" class="block mt-1 w-full" type="text" name="company_name"
                            :value="old('company_name', $company['company_name'])" required autofocus autocomplete="username" />
                    ...
                    <div>
                        ...
                        <x-text-input id="company_email" class="block mt-1 w-full" type="email" name="company_email"
                            :value="old('company_email', $company['company_email'])" required autofocus autocomplete="username" />
                    ...
                    <div>
                        ...
                        <x-text-input id="company_number" class="block mt-1 w-full" type="text" name="company_number"
                            :value="old('company_number', $company['company_number'])" required autofocus autocomplete="username" />
                    ...
                    <div>
                        ...
                        <x-text-input id="company_address" class="block mt-1 w-full" type="text"
                            name="company_address" :value="old('company_address', $company['company_address'])" required autofocus autocomplete="username" />
                    ...
                    <div>
                        ...
                        <x-text-input id="owner_name" class="block mt-1 w-full" type="text" name="owner_name"
                            :value="old('owner_name', $company['owner']['owner_name'])" required autofocus autocomplete="username" />
                    ...
                    <div>
                        ...
                        <x-text-input id="owner_email" class="block mt-1 w-full" type="email" name="owner_email"
                            :value="old('owner_email', $company['owner']['owner_email'])" required autofocus autocomplete="username" />
                    ...
                    <div>
                        ...
                        <x-text-input id="owner_number" class="block mt-1 w-full" type="text" name="owner_number"
                            :value="old('owner_number', $company['owner']['owner_number'])" required autofocus autocomplete="username" />
                    ...
                    <div>
                        ...
                        <x-text-input id="contact_name" class="block mt-1 w-full" type="text" name="contact_name"
                            :value="old('contact_name', $company['contact']['contact_name'])" required autofocus autocomplete="username" />
                    ...
                    <div>
                        ...
                        <x-text-input id="contact_email" class="block mt-1 w-full" type="email" name="contact_email"
                            :value="old('contact_email', $company['contact']['contact_email'])" required autofocus autocomplete="username" />
                    ...
                    <div>
                        ...
                        <x-text-input id="contact_number" class="block mt-1 w-full" type="text" name="contact_number"
                            :value="old('contact_number', $company['contact']['contact_number'])" required autofocus autocomplete="username" />
